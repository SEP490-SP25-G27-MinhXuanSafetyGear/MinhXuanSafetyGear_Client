...
import { FaFilter, FaClock, FaArrowRight, FaHome } from 'react-icons/fa';
...
const BlogList = () => {
    ...
    const sampleBlogs = Array(6).fill({
    ...
    return (
        <div className="blog-container">
            <nav className="breadcrumb-blog-list">
                ...
                <span className="breadcrumb-item active">Kiến thức an toàn lao động</span>
            </nav>

            <div className="blog-list-container">
                <div className="blog-filter">
                    <div className="filter-header" onClick={toggleFilterOptions}>
                        <FaFilter className="filter-icon" />
                        <span className="filter-title">BỘ LỌC TIN TỨC</span>
                    </div>
                    <div className={`filter-options ${filterActive ? 'active' : ''}`}>
