          ...
          <div className="confirm-success-content">
            ...
            <div className="confirm-button-group">
              <button
                ...
                className="confirm-btn-continue"
              >
                Tiếp tục mua sắm
              </button>
              <button
                onClick={handleViewOrderHistory}
                className="confirm-btn-view-order"
              >
      ...
      <div className="confirm-order-card">
        <div className="confirm-order-header">
          <h1 className="confirm-order-title">
            <Truck
              className={`confirm-icon ${
                truckAnimation ? "confirm-truck-move" : ""
              }`}
            />
            Xác nhận đơn hàng
          </h1>
        ...
        <div className="confirm-order-content">
          ...
          <div className="confirm-section">
            ...
            <div className="confirm-payment-options">
              <label
                className={`confirm-payment-option ${
                  customerInfo.paymentMethod === "Cash" ? "confirm-active" : ""
                }`}
              >
                <input
                  type="radio"
                ...
                <tbody>
                  {orderData.orderDetails.map((item, index) => (
                    <tr
                      ...
                      className={
                        index % 2 === 0 ? "confirm-even" : "confirm-odd"
                      }
                    >
                      <td>
