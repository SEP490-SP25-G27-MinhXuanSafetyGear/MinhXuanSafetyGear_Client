		...
		switch (currentStep) {
			case 1: // Basic Information
				return product.name && product.category && product.description &&
					product.material && product.origin && product.qualityCertificate;
								...
								<div className="flex items-start">
									...
									<div className="ml-3">
										...
										<div className="mt-2 text-sm text-blue-700">
											<p>The base price is the standard price for this product. You can set different prices for each variant in the variants section.</p>
										</div>
									</div>
								</div>
							</div>
									...
									<div className="flex items-start">
										...
										<div className="ml-3">
											...
											<div className="mt-2 text-sm text-yellow-700">
												<p>Please upload at least one image for your product. High-quality images help customers make purchase decisions.</p>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
								<div className="flex items-start">
									...
									<div className="ml-3">
										...
										<div className="mt-2 text-sm text-blue-700">
											<p>Variants allow you to offer different versions of the same product (e.g., different sizes, colors). If your product doesn't have variants, you can skip this step.</p>
										</div>
									</div>
								</div>
							</div>
